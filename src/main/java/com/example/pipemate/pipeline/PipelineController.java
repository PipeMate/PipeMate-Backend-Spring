...
//
//    @PostMapping("/convert")
//    @Operation(summary = "워크플로우 JSON 변환 및 저장",
//            description = "input.json을 받아서 res_input.json으로 변환하고 MongoDB에 저장, YAML로 변환하여 GitHub에 업로드합니다.")
//    public ResponseEntity<PipelineResponse> convertAndSaveWorkflow(
...
//
//        PipelineResponse response = workflowConversionService.convertAndSaveWorkflow(request, cleanToken);
